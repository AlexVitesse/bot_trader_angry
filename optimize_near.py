...
df = pd.read_parquet(DATA_DIR / 'NEAR_USDT_4h_full.parquet')
...
model_path = MODELS_DIR / 'near_usdt_v2_gradientboosting.pkl'
...
doc_path = DOCS_DIR / 'OPTIMIZACION_NEAR.md'
...
print("\n" + "="*70)
print("OPTIMIZACION NEAR COMPLETADA")
print("="*70)
print(f"\nConfiguracion final:")
