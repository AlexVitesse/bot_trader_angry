...
df = pd.read_parquet(DATA_DIR / 'ETH_USDT_4h_full.parquet')
...
model_path = MODELS_DIR / 'eth_usdt_v2_gradientboosting.pkl'
...
doc_path = DOCS_DIR / 'OPTIMIZACION_ETH.md'
...
print("\n" + "="*70)
print("OPTIMIZACION ETH COMPLETADA")
print("="*70)
print(f"\nConfiguracion final:")
