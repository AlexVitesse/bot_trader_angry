...
df = pd.read_parquet(DATA_DIR / 'AVAX_USDT_4h_full.parquet')
...
model_path = MODELS_DIR / 'avax_usdt_v2_gradientboosting.pkl'
...
doc_path = DOCS_DIR / 'OPTIMIZACION_AVAX.md'
...
print("\n" + "="*70)
print("OPTIMIZACION AVAX COMPLETADA")
print("="*70)
print(f"\nConfiguracion final:")
