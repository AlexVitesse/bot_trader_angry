...
df = pd.read_parquet(DATA_DIR / 'XRP_USDT_4h_full.parquet')
...
model_path = MODELS_DIR / 'xrp_usdt_v2_gradientboosting.pkl'
...
doc_path = DOCS_DIR / 'OPTIMIZACION_XRP.md'
...
print("\n" + "="*70)
print("OPTIMIZACION XRP COMPLETADA")
print("="*70)
print(f"\nConfiguracion final:")
